...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'name' => [
            ...
            'unique' => 'This brand name already exists. Please choose a different name.',
            'max' => 'The brand name may not be greater than :max characters.',
            'string' => 'The brand name must be a text value.',
            'exists' => 'The selected brand name does not exist.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'department_name_ar' => 'Arabic department name',
        'description' => 'description',
        'description_en' => 'English description',
        'description_ar' => 'Arabic description',
        'order' => 'order',
        ...
        'name_en' => 'English governorate name',
        'name_ar' => 'Arabic governorate name',
        'country_id' => 'country',
    ],
